...
\item\bf{Technology}{: NodeJS | MYSQL | ReactJS }
...
%\divider
\item\bf{Web Technologies}\normalfont{: ReactJS, Angular 6, NodeJS, Express(Node Framework), PHP(CodeIgnitor, Jommla), ParseServer, Firebase}
%\divider
...
\cvproject{SaveMudra (savemudra.com)}
\begin{itemize}
